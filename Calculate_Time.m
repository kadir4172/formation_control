...
artificial_forces_t_1   = 167;
bubble_packing_t_1      = 133;
randomized_fractals_t_1 = 144;

artificial_forces_t_2  =185;
bubble_packing_t_2     =168;
randomized_fractals_t_2 = 171;
...
%shape 1 
a_f_t = amplitude * sin(2*pi*f1*i) + amplitude * sin(2*pi*fr*i) + amplitude*5 * sin(2*pi*fy*i);

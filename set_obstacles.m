...
grid_map_1 = test_inside_outside(obstacle_1_x , obstacle_1_y, grid_map_in, x_max, y_max); %obstaclerin icinde dogmayalim diye biraz daha genislettik
grid_map_2 = test_inside_outside(obstacle_2_x , obstacle_2_y, grid_map_1, x_max, y_max); %obstaclerin icinde dogmayalim diye biraz daha genislettik
grid_map = test_inside_outside(obstacle_3_x , obstacle_3_y, grid_map_2, x_max, y_max); %obstaclerin icinde dogmayalim diye biraz daha genislettik
...
assignin('base', 'obstacle_2_x', obstacle_2_x);
assignin('base', 'obstacle_2_y', obstacle_2_y);
assignin('base', 'obstacle_3_x', obstacle_3_x);

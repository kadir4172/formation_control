...
\begin{center}
\captionof{table}{Mass,Friction Coefficient and Coverage Circle Radius for Different Types of Agents} \label{agent_props} 
...
The results of the Monte Carlo simulations with 1000 iterations are illustrated in Figure \ref{total_dist_2}

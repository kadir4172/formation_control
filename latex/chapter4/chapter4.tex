...
\centerline{\includegraphics[scale = 0.26]{Pozisyon-1-Duzeltilmis}}
\end{figure} 
...
\centering
\centerline{\includegraphics[scale = 0.26]{Lost-2-2}}
\end{figure} 

\begin{figure}[H]
\captionsetup{format=hang,justification=centerfirst}
\caption{Agents will be in 'Come Home' Mode After Being Lost for 3 Times} \label{come_home_ref}
\centerline{\includegraphics[scale = 0.26]{Lost-2-3}}
\end{figure} 		
...
\centerline{\includegraphics[scale = 0.32]{combo1}}
\end{figure} 

\begin{figure}[H]
\caption{Latency in Bubble Packing Method-2} \label{combo2_ref}
\centerline{\includegraphics[scale = 0.32]{combo2}}
\end{figure} 

\begin{figure}[H]
\caption{Latency in Bubble Packing Method-3} \label{combo3_ref}
\centerline{\includegraphics[scale = 0.32]{combo3}}
\end{figure} 

...
\begin{figure}[H]
	\caption{Accuracy Statistics of Different Positioning Sources} \label{overview_position}
	\centering
...
\begin{figure}[H]
	\caption{Trilateration Process} \label{trilateration_ref}
	\centering
...
\begin{figure}[H]
	\caption{Space Filling Examples with Randomized Fractals} \label{space_filling}
	\centering
...
\begin{figure}[H]
	\caption{Interbubble Forces} \label{interbubble_ref}
	\centering
...
\begin{figure}[H]
	\caption{Mesh Generation with Interbubble Forces} \label{mesh_genearation_ref}
	\centering

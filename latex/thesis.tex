...
\committeememberv[assocprof]{Yiğit Yazıcıoğlu}
\affiliationv{Mechanical Engineering Department, METU}

\committeememberiv[assistprof]{Elif Vural}
\affiliationiv{Electrical and Electronics Engineering Department, METU}

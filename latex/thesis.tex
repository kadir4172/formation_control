...
\committeememberii[assocprof]{Sedat Nazlıbilek}
\affiliationii{Mechatronics Engineering Department, Atılım University}

\committeememberiii[assocprof]{Umut Örgüner}
